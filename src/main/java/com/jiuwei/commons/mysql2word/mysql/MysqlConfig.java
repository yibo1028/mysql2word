...
public abstract class MysqlConfig {
	...
	private static final String HOST = "192.168.1.240";// 需要修改此处
	private static final String PORT = "3306";// 需要修改此处
	private static final String DATABASE = "kksass";// 需要修改此处
	private static final String USER = "root";// 需要修改此处
	private static final String PWD = "whatthefuck";// 需要修改此处

	private static final String DRIVER = "com.mysql.jdbc.Driver";
	private static final String URL = "jdbc:mysql://" + HOST + ":" + PORT + "/"
			+ DATABASE + "?user=" + USER + "&password=" + PWD
			+ "&useUnicode=true&characterEncoding=UTF-8&remarks=true&useInformationSchema=true";
